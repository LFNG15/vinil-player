...
template <> constexpr inline auto HomePage::qt_create_metaobjectdata<qt_meta_tag_ZN8HomePageE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'navigateTo'
        QtMocHelpers::SignalData<void(const QString &)>(7, 2, QMC::AccessPublic | QMC::MethodCloned, QMetaType::Void, {{
            { QMetaType::QString, 8 },
        }}),
    };
...
void HomePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->navigateTo((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        case 3: _t->navigateTo((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (HomePage::*)(const Track & )>(_a, &HomePage::playRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (HomePage::*)(const QString & )>(_a, &HomePage::likeToggled, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (HomePage::*)(const QString & , const QString & )>(_a, &HomePage::navigateTo, 2))
            return;
    }
}
...
// SIGNAL 0
void HomePage::playRequested(const Track & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void HomePage::likeToggled(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void HomePage::navigateTo(const QString & _t1, const QString & _t2)
{
